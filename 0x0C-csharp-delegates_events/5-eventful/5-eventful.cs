...
public class Player
{
	...
	/// <summary>Warns when the player is about to die.</summary>
	/// <param name="sender">The sender.</param>
	/// <param name="e">The <see cref="CurrentHPArgs"/> instance containing the event data.</param>
	...
	/// <summary>Gets the player's status.</summary>
